        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(type: "TEXT", nullable: false),
                    TitleEs = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabelEs = table.Column<string>(type: "TEXT", nullable: false),
                    LabelEn = table.Column<string>(type: "TEXT", nullable: false),
                    Price = table.Column<decimal>(type: "TEXT", nullable: false),
                    IsAvailable = table.Column<bool>(type: "INTEGER", nullable: false),
                    AcceptsDesignFile = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignFileId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_DesignFiles_DesignFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductVariantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProductTitleEs = table.Column<string>(type: "TEXT", nullable: false),
                    ProductTitleEn = table.Column<string>(type: "TEXT", nullable: false),
                    VariantLabelEs = table.Column<string>(type: "TEXT", nullable: false),
                    VariantLabelEn = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_DesignFiles_DesignFileId",
                        column: x => x.DesignFileId,
                        principalTable: "DesignFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_DesignFileId",
                table: "CartItems",
                column: "DesignFileId");
