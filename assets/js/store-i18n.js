...
(function () {
    ...
    var storeKeys = {
        ...
        es: {
            ...
            'status.Paid':           'Pagado',
            'status.InProduction':   'En Preparación',
            ...
            'timeline.inProduction':    'En Preparación',
            'timeline.preparing':       'En Preparación',
        ...
        de: {
            ...
            'status.Paid':           'Bezahlt',
            'status.InProduction':   'In Vorbereitung',
            ...
            'timeline.inProduction':    'In Vorbereitung',
            'timeline.preparing':       'In Vorbereitung',
        ...
        pt: {
            ...
            'status.Paid':           'Pago',
            'status.InProduction':   'Em Preparação',
            ...
            'timeline.paid':            'Pago',
            'timeline.inProduction':    'Em Preparação',
            'timeline.preparing':       'Em Preparação',
            'timeline.shipped':         'Enviado',
        ...
        ja: {
            ...
            'timeline.paid':            '支払い済み',
            'timeline.inProduction':    '準備中',
            'timeline.preparing':       '準備中',
        ...
        zh: {
            ...
            'timeline.paid':            '已付款',
            'timeline.inProduction':    '准备中',
            'timeline.preparing':       '准备中',
    ...
    // Expose as window.t for convenience on pages that load store-i18n.js
    if (!window.t) {
        window.t = window.StoreI18n.t;
    }
