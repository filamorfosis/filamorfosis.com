...
window.FilamorfosisI18n['pt'] = {
            ...
            cat_all: 'Todos',
            admin_categories_tab: 'Categorias de Produtos',
            admin_new_category: 'Nova Categoria',
            admin_category_name: 'Nome',
            admin_category_slug: 'Slug (URL)',
            admin_category_description: 'Descrição',
            admin_category_icon: 'Ícone/Emoji',
            admin_category_display_order: 'Ordem de exibição',
            admin_category_parent: 'Categoria pai',
            admin_category_active: 'Ativa',
            admin_category_save: 'Salvar categoria',
            admin_category_delete_confirm: 'Tem certeza de que deseja excluir esta categoria?',
            admin_category_has_children_error: 'Não é possível excluir uma categoria que possui subcategorias',
            admin_categories_column: 'Categorias',
            admin_no_categories: 'Sem categorias',
            admin_more_categories: 'mais',
            nav_tienda: 'Loja',
            nav_tienda_menu: 'Abrir menu Loja',
            nav_servicios: 'Serviços',
            nav_servicios_menu: 'Abrir menu Serviços',
            nav_inicio: 'Início',
            nav_login: 'Entrar',
            nav_user_greeting: 'Olá,',
            nav_my_profile: 'Meu Perfil',
            nav_my_addresses: 'Meus Endereços',
            nav_my_orders: 'Meus Pedidos',
            nav_register: 'Registrar-se',
            nav_conocenos: 'Quem Somos',
            nav_faq_mega: 'Perguntas Frequentes',
            nav_contacto: 'Contato',
            nav_mega_store_heading: 'Explorar Loja',
            nav_mega_store_promo_title: 'A partir de 1 peça',
            nav_mega_store_promo_desc: 'Sem mínimos. Sem desculpas.',
            nav_mega_store_cta: 'Ver todos os produtos',
            nav_mega_store_loading: 'Carregando categorias...',
            nav_mega_store_error: 'Erro ao carregar categorias',
            nav_mega_store_retry: 'Tentar novamente',
            nav_mega_store_timeout: 'O carregamento demorou muito. Por favor, tente novamente.',
            nav_mega_services_heading: 'Nossos Serviços',
            nav_mega_svc_3d_title: 'Impressão 3D',
            nav_mega_svc_3d_desc: 'Multicolor e multimaterial',
            nav_mega_svc_uv_title: 'Impressão UV',
            nav_mega_svc_uv_desc: 'Em canecas, madeira, metal e mais',
            nav_mega_svc_laser_title: 'Corte a Laser',
            nav_mega_svc_laser_desc: 'Precisão cirúrgica',
            nav_mega_svc_scan_title: 'Escaneamento 3D',
            nav_mega_svc_scan_desc: 'Digitalize qualquer objeto',
            nav_mega_svc_photo_title: 'Impressão Fotográfica',
            nav_mega_svc_photo_desc: 'Qualidade profissional',
            nav_mega_about_heading: 'Quem Somos',
            nav_mega_about_who: 'Nossa História',
            nav_mega_about_mission: 'Missão e Valores',
            nav_mega_about_process: 'Nosso Processo',
            nav_mega_about_blog: 'Blog',
            nav_mega_about_clients_label: 'Clientes satisfeitos',
            nav_mega_about_testimonial: '"Qualidade incrível e entrega rápida"',
            nav_cart_label: 'Carrinho',
            nav_account_label: 'Minha conta',
            ...
            'auth.forgotDesc': 'Digite seu e-mail e enviaremos um link de redefinição.',
            'auth.sendReset': 'Enviar link',
            'auth.backToLogin': '← Voltar ao login',
            'auth.reqLength': 'Mínimo 8 caracteres',
            'auth.reqUpper': 'Uma letra maiúscula',
            'auth.reqDigit': 'Um número',
            sort_by: 'Ordenar',
            sort_default: 'Relevância',
            sort_name_asc: 'Nome A-Z',
            sort_name_desc: 'Nome Z-A',
            sort_price_asc: 'Preço: menor primeiro',
            sort_price_desc: 'Preço: maior primeiro',
            sort_most_sold: 'Mais vendidos',
            sort_best_reviews: 'Melhor avaliados',
            all_products: 'Todos os produtos: (Selecione uma categoria à esquerda)',
        };
