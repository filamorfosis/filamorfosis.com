...
window.FilamorfosisI18n['es'] = {
            ...
            cat_all: 'Todos',
            admin_categories_tab: 'Categorías de Producto',
            admin_new_category: 'Nueva Categoría',
            admin_category_name: 'Nombre',
            admin_category_slug: 'Slug (URL)',
            admin_category_description: 'Descripción',
            admin_category_icon: 'Icono/Emoji',
            admin_category_display_order: 'Orden de visualización',
            admin_category_parent: 'Categoría padre',
            admin_category_active: 'Activa',
            admin_category_save: 'Guardar categoría',
            admin_category_delete_confirm: '¿Estás seguro de que deseas eliminar esta categoría?',
            admin_category_has_children_error: 'No se puede eliminar una categoría que tiene subcategorías',
            admin_categories_column: 'Categorías',
            admin_no_categories: 'Sin categorías',
            admin_more_categories: 'más',
            nav_tienda: 'Tienda',
            nav_tienda_menu: 'Abrir menú Tienda',
            nav_servicios: 'Servicios',
            nav_servicios_menu: 'Abrir menú Servicios',
            nav_inicio: 'Inicio',
            nav_login: 'Iniciar Sesión',
            nav_user_greeting: 'Hola,',
            nav_my_profile: 'Mi Perfil',
            nav_my_addresses: 'Mis Direcciones',
            nav_my_orders: 'Mis Pedidos',
            nav_register: 'Registrarse',
            nav_conocenos: 'Conócenos',
            nav_faq_mega: 'Preguntas Frecuentes',
            nav_contacto: 'Contacto',
            nav_mega_store_heading: 'Explorar Tienda',
            nav_mega_store_promo_title: 'Desde 1 pieza',
            nav_mega_store_promo_desc: 'Sin mínimos. Sin excusas.',
            nav_mega_store_cta: 'Ver todos los productos',
            nav_mega_store_loading: 'Cargando categorías...',
            nav_mega_store_error: 'Error al cargar categorías',
            nav_mega_store_retry: 'Reintentar',
            nav_mega_store_timeout: 'La carga tardó demasiado. Intenta de nuevo.',
            nav_mega_services_heading: 'Nuestros Servicios',
            nav_mega_svc_3d_title: 'Impresión 3D',
            nav_mega_svc_3d_desc: 'Multicolor y multimaterial',
            nav_mega_svc_uv_title: 'Impresión UV',
            nav_mega_svc_uv_desc: 'En tazas, madera, metal y más',
            nav_mega_svc_laser_title: 'Corte Láser',
            nav_mega_svc_laser_desc: 'Precisión quirúrgica',
            nav_mega_svc_scan_title: 'Escaneo 3D',
            nav_mega_svc_scan_desc: 'Digitaliza cualquier objeto',
            nav_mega_svc_photo_title: 'Impresión Fotográfica',
            nav_mega_svc_photo_desc: 'Calidad profesional',
            nav_mega_about_heading: 'Conócenos',
            nav_mega_about_who: 'Quiénes Somos',
            nav_mega_about_mission: 'Misión y Valores',
            nav_mega_about_process: 'Nuestro Proceso',
            nav_mega_about_blog: 'Blog',
            nav_mega_about_clients_label: 'Clientes satisfechos',
            nav_mega_about_testimonial: '"Calidad increíble y entrega rápida"',
            nav_cart_label: 'Carrito',
            ...
            'auth.reqUpper': 'Una letra mayúscula',
            'auth.reqDigit': 'Un número',
            ...
            sort_by: 'Ordenar',
            sort_default: 'Relevancia',
            sort_name_asc: 'Nombre A-Z',
            sort_name_desc: 'Nombre Z-A',
            sort_price_asc: 'Precio: menor primero',
            sort_price_desc: 'Precio: mayor primero',
            sort_most_sold: 'Más vendidos',
            sort_best_reviews: 'Mejor calificados',
            all_products: 'Todos los productos: (Selecciona una categoría del lado izquierdo)',
        };
