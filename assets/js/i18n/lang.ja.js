...
window.FilamorfosisI18n['ja'] = {
            ...
            cat_art: 'アート＆デザイン',
            cat_all: 'すべて',
            admin_categories_tab: '商品カテゴリー',
            admin_new_category: '新しいカテゴリー',
            admin_category_name: '名前',
            admin_category_slug: 'スラッグ（URL）',
            admin_category_description: '説明',
            admin_category_icon: 'アイコン/絵文字',
            admin_category_display_order: '表示順序',
            admin_category_parent: '親カテゴリー',
            admin_category_active: '有効',
            admin_category_save: 'カテゴリーを保存',
            admin_category_delete_confirm: 'このカテゴリーを削除してもよろしいですか？',
            admin_category_has_children_error: 'サブカテゴリーを持つカテゴリーは削除できません',
            admin_categories_column: 'カテゴリー',
            admin_no_categories: 'カテゴリーなし',
            admin_more_categories: '件以上',
            nav_tienda: 'ストア',
            nav_tienda_menu: 'ストアメニューを開く',
            nav_servicios: 'サービス',
            nav_servicios_menu: 'サービスメニューを開く',
            nav_inicio: 'ホーム',
            nav_login: 'ログイン',
            nav_user_greeting: 'こんにちは、',
            nav_my_profile: 'マイプロフィール',
            nav_my_addresses: '住所一覧',
            nav_my_orders: '注文履歴',
            nav_register: '新規登録',
            nav_conocenos: '私たちについて',
            nav_faq_mega: 'よくある質問',
            nav_contacto: 'お問い合わせ',
            nav_mega_store_heading: 'ストアを探す',
            nav_mega_store_promo_title: '1個から注文可能',
            nav_mega_store_promo_desc: '最小ロットなし。言い訳なし。',
            nav_mega_store_cta: 'すべての製品を見る',
            nav_mega_store_loading: 'カテゴリーを読み込み中...',
            nav_mega_store_error: 'カテゴリーの読み込みエラー',
            nav_mega_store_retry: '再試行',
            nav_mega_store_timeout: '読み込みに時間がかかりすぎています。再試行してください。',
            nav_mega_services_heading: 'サービス一覧',
            nav_mega_svc_3d_title: '3Dプリント',
            nav_mega_svc_3d_desc: 'マルチカラー・マルチマテリアル',
            nav_mega_svc_uv_title: 'UVプリント',
            nav_mega_svc_uv_desc: 'マグカップ、木材、金属など',
            nav_mega_svc_laser_title: 'レーザーカット',
            nav_mega_svc_laser_desc: '外科的精度',
            nav_mega_svc_scan_title: '3Dスキャン',
            nav_mega_svc_scan_desc: 'あらゆる物体をデジタル化',
            nav_mega_svc_photo_title: '写真プリント',
            nav_mega_svc_photo_desc: 'プロフェッショナル品質',
            nav_mega_about_heading: '私たちについて',
            nav_mega_about_who: '私たちとは',
            nav_mega_about_mission: 'ミッションと価値観',
            nav_mega_about_process: '私たちのプロセス',
            nav_mega_about_blog: 'ブログ',
            nav_mega_about_clients_label: '満足したお客様',
            nav_mega_about_testimonial: '「素晴らしい品質と迅速な配送」',
            nav_cart_label: 'カート',
            nav_account_label: 'マイアカウント',
            ...
            'auth.forgotDesc': 'メールアドレスを入力すると、リセットリンクをお送りします。',
